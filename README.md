...
The raw experimental kinematic data utilized in this repository was originally acquired in 2024 as part of a research project that secured me the first place at the 20th Open Inter-School Physics Competition. However, the entirety of the analytical framework, computational validation, statistical uncertainty propagation, and the final technical report were developed during my first year of Aerospace Engineering at Delft University of Technology.
...
![Correlation between Experimental and Computational Drag Coefficients](results/figure_final.png)
